...
cds.on('bootstrap', app => {
    ...
    if (cds.env.requires?.ECPersonalInformation?.credentials?.authentication === "BasicAuthentication") {
        const credentials = process.env;
        cds.env.requires.ECPersonalInformation.credentials.url = credentials.base_url;
        cds.env.requires.ECPersonalInformation.credentials.username = credentials.username;
        cds.env.requires.ECPersonalInformation.credentials.password = credentials.password;
    }
